class Calendario::Evento < ApplicationRecord
    ...
    ACTIVIDAD = ["Conferencia / Plática", "Concierto", "Conversatorio", "Curso / Taller", "Difusión en medios de comunicación", "Entrevista", "Exposición fotográfica", "Foro", "Limpieza", "Observación de aves", "Presentación de libro", "Puertas abiertas", "Proyección", "Recorridos", "Reforestación", "Restauración", "Reunión", "Visita guiada", "Eventos Naturalista", "Otra"].freeze
    FORMATO = ["Presencial", "Virtual", "Híbrido"].freeze
