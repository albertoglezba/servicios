class InstrumentosController < ApplicationController
  ...
  def index
    @instrumentos = DatInstrumentoLegal.consulta
  end
  ...
  private
    ...
    def instrumento_params
      params.require(:instrumento).permit(:Identificador1, :Grupo, :TipoInstrumentoLegal, :Objeto, :MontoTotal, :VersionPublica, :Nombre, :Apellido, :DatoPersonaAreaInstutucion)
    end
end
